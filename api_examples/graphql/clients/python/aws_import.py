...
# -c .config/turbot/credentials.yml --profile env --parent 100000000000000 --account 900000000000 --role_arn arn:aws:iam::900000000000:role/turbot_service_role --external_id 50000000
@click.command()
...
@click.option('--role_arn', required=True, help="The role ARN to be assumed into the account")
@click.option('--external_id', required=True, help="The external ID used to validate the assume role")
