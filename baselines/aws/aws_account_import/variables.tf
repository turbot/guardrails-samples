...
variable "read_only_access" {
    description = "By default, Turbot is installed with administrator access to enable full functionlity.  If you wish to install Turbot in readonly mode (plus limited admin access to set up event routing) change this value to `true`"
    default = true
}
