# Baseline - AWS Check Tagging

This baseline will allow you to check for adhernece to the tagging templates, make sure that the Tag Templates are updated with the specific use case to validate.ß
