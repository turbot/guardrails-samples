...
This baseline will allow you to check the infrastructure over X days/unattached volumes and discs. This also will allow you to set resource scheduling and make it inactive to reduce the cost.
