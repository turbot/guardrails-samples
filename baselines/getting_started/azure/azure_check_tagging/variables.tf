...
variable "set_resource_tag_policies" {
  type        = bool
  description = "Set resource tag policies for baseline"
  default     = true
}

variable "default_tag_template" {
  type        = bool
  description = "Set defualt tag template policies for baseline"
  default     = true
}
