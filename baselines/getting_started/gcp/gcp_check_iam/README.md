# Baseline - GCP Check IAM Policies

GCP Check IAM Policies focuses on enabling all IAM resources baseline policies. Some policies are enabled with industry standard best practices and some are enabled with check mode to validate.
