...
output "enable_service_account_key_approved_policies" {
  value = var.enable_service_account_key_approved_policies
}

output "enable_service_account_policy_trusted_domains_policies" {
  value = var.enable_service_account_trusted_access_policies
}
