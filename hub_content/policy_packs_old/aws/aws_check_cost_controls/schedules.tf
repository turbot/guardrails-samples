...
# Scheduling in Turbot - https://turbot.com/v5/docs/concepts/guardrails/scheduling
...
resource "turbot_policy_setting" "aws_rds_db_cluster_schedule" {
  count    = var.enable_rds_db_cluster_schedule_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
...
count    = var.enable_rds_cluster_schedule_tag_policies ? 1 : 0
resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_rds_db_instance_schedule" {
  count    = var.enable_rds_db_instance_schedule_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_rds_db_instance_schedule_tag" {
count    = var.enable_rds_db_instance_schedule_tag_policies ? 1 : 0
resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_redshift_cluster_schedule" {
  count    = var.enable_redshift_cluster_schedule_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_redshift_cluster_schedule_tag" {
  count    = var.enable_redshift_cluster_schedule_tag_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_workspace_schedule" {
  count    = var.enable_workspace_schedule_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
...
resource "turbot_policy_setting" "aws_workspace_schedule_tag" {
  count    = var.enable_workspace_schedule_tag_policies ? 1 : 0
  resource = turbot_smart_folder.aws_cost_controls.id
