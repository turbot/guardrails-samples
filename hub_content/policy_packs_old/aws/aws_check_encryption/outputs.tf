...
output "enable_backup_vault_approved_policies" {
  value = var.enable_backup_vault_approved_policies
}

output "enable_backup_vault_encryption_policies" {
  value = var.enable_backup_vault_encryption_policies
}

output "enable_dynamodb_table_encryption_policies" {
...
output "enable_rds_instance_approved_policies" {
  value = var.enable_rds_instance_approved_policies
}

output "enable_rds_instance_encryption_policies" {
  value = var.enable_rds_instance_encryption_policies
}

output "enable_rds_manualsnapshot_approved_policies" {
  value = var.enable_rds_manualsnapshot_approved_policies
}

output "enable_rds_manualsnapshot_encryption_policies" {
