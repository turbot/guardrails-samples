...
**[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_ec2_enforce_termination_protection_is_enabled_for_instances/settings)**
...
cd guardrails-samples/policy_packs/aws/ec2/enforce_termination_protection_is_enabled_for_instances
```
