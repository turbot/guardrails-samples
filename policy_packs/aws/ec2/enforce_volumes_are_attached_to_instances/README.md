...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_ec2_enforce_volumes_are_attached_to_instances/settings)**
...
cd guardrails-samples/policy_packs/aws/ec2/enforce_volumes_are_attached_to_instances
```
