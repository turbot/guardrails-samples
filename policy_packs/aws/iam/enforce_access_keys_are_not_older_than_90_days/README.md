...
- **[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_iam_enforce_access_keys_are_not_older_than_90_days/settings)**
...
cd guardrails-samples/policy_packs/aws/iam/enforce_access_keys_are_not_older_than_90_days
```
