...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_iam_eenforce_roles_restrict_access/settings)**
...
cd guardrails-samples/policy_packs/aws/iam/enforce_roles_restrict_access
```
