...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_lambda_enforce_functions_are_in_vpc/settings)**
...
cd guardrails-samples/policy_packs/aws/lambda/enforce_functions_are_in_vpc
```
