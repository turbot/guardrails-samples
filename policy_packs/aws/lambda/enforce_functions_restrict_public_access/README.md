...
- **[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_lambda_enforce_functions_restrict_public_access/settings)**
...
cd guardrails-samples/policy_packs/aws/lambda/enforce_functions_restrict_public_access
```
