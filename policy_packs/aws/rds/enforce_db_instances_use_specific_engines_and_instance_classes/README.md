...
- **[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_rds_enforce_db_instances_use_specific_engines_and_instance_classes/settings)**
...
cd guardrails-samples/policy_packs/aws/rds/enforce_db_instances_use_specific_engines_and_instance_classes
```
