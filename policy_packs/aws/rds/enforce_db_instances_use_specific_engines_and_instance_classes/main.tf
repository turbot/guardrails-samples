resource "turbot_policy_pack" "main" {
  title       = "Enforce AWS RDS DB Instances Use Specific Engines and Instance Classes"
  ...
  akas        = ["aws_rds_enforce_db_instances_use_specific_engines_and_instance_classes"]
}
