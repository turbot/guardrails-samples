...
**[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_rds_enforce_manual_db_instance_snapshots_are_shared_with_trusted_accounts/settings)**
...
cd guardrails-samples/policy_packs/aws/rds/enforce_manual_db_instance_snapshots_are_shared_with_trusted_accounts
```
