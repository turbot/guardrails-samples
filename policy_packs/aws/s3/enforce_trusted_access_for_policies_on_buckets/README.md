...
# Enforce Trusted Access for Policies on Buckets
...
- Enforce that policies do not grant access to all AWS users.
- Ensure that bucket access is limited to trusted AWS accounts only.

## Documentation

- **[Review Policy settings →](https://hub-guardrails-turbot-com-git-development-turbot.vercel.app/policy-packs/enforce_trusted_access_for_policies_on_buckets/settings)**
...
cd guardrails-samples/policy_packs/aws/s3/enforce_trusted_access_for_policies_on_buckets
```
