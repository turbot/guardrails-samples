...
**[Review policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_sqs_enforce_queues_restrict_access/settings)**
...
cd guardrails-samples/policy_packs/aws/sqs/enforce_queues_restrict_access
```
