...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_vpc_enforce_default_security_groups_are_deleted/settings)**
...
cd guardrails-samples/policy_packs/aws/vpc/enforce_default_security_groups_are_deleted
```
