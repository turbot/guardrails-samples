...
# Enforce AWS VPC Elastic IPs Are Associated
...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_vpc_enforce_elastic_ips_are_associated/settings)**
...
cd guardrails-samples/policy_packs/aws/vpc/enforce_elastic_ips_are_associated
```
