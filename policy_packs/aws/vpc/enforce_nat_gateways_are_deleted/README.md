...
# Enforce NAT Gateways Are Deleted
...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_vpc_enforce_nat_gateways_are_deleted/settings)**
...
cd guardrails-samples/policy_packs/aws/vpc/enforce_nat_gateways_are_deleted
```
