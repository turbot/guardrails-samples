...
# Enforce AWS VPCs Have Transit Gateways Attached
...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/aws_vpc_enforce_vpcs_have_transit_gateways_attached/settings)**
...
cd guardrails-samples/policy_packs/aws/vpc/enforce_vpcs_have_transit_gateways_attached
```
