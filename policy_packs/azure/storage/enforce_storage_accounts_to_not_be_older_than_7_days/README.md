...
- Delete storage accounts that are older than 7 days

**[Review policy settings →](https://hub-guardrails-turbot-com-git-development-turbot.vercel.app/policy-packs/enforce_storage_accounts_to_not_be_older_than_7_days/settings)**
...
cd guardrails-samples/policy_packs/azure/storage/enforce_storage_accounts_to_not_be_older_than_7_days
```
