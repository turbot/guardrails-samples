...
cd guardrails-samples/policy_packs/gcp/computeengine/enforce_user_service_account_keys_have_90_days_rotation
```
...
Within the Guardrails UI navigate to:
  ...
  ```sh
  {workspace-url}/apollo/controls/explore?filter=controlTypeId%3A%27tmod%3A%40turbot%2Fgcp-iam%23%2Fcontrol%2Ftypes%2FserviceAccountKeyActive%27
  ```
