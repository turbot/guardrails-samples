...
- Enforce discussions are enabled for repositories

## Documentation

- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/github_enforce_discussions_are_enabled_for_repositories/settings)**
...
cd guardrails-samples/policy_packs/github/enforce_discussions_are_enabled_for_repositories
```
