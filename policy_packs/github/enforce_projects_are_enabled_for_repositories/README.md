...
Enforcing that GitHub repositories have projects enabled provides a flexible and integrated way to plan, track, and manage work using kanban-style boards, task lists, and project views directly linked to issues and pull requests.
...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/github_enforce_projects_are_enabled_for_repositories/settings)**
...
cd guardrails-samples/policy_packs/github/enforce_projects_are_enabled_for_repositories
```
