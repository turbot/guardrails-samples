...
Enforcing that GitHub repositories have secret scanning enabled detects sensitive information, such as API keys, tokens, passwords, and other credentials, that may accidentally be committed to the repository.
...
- **[Review Policy settings →](https://hub.guardrails.turbot.com/policy-packs/github_enforce_secret_scanning_is_enabled_for_repositories/settings)**
...
cd guardrails-samples/policy_packs/github/enforce_secret_scanning_is_enabled_for_repositories
```
