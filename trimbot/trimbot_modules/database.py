...
#                     Key=key_info
#                 )
#                 self.logger.info(f'Successfully deleted {key_info} from table {table_name}')
#             except Exception as e:
#                 if e.response["Error"]["Code"] == "ResourceNotFoundException":
#                     self.logger.error(f'Table not found {table_name}')
#                 raise
#         else:
#             self.logger.info(f'Would successfully deleted {key_info} from table {table_name}')
